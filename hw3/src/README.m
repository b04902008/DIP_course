...
%   - Function M-file name: erode.m
% Implementation (b): count the objects
%   - Function M-file name: dilate.m
% Implementation (c): skeletonizing
%
% M-file name: pro1_a.m, pro1_b.m, pro1_c.m
% Usage: pro1_a, pro1_b, pro1_c
% Input Image: ../raw/sample1.raw
% Output Image: ../out/I1.bmp, ../out/B.raw, ../out/B.bmp
%               ../out/S.raw, ../out/S.bmp
...
%   - Function M-file name: lawsMethod.m, mask.m, reduct_noise.m
...
% Output image: ../out/I2.bmp, ../out/K.raw, ../out/K.bmp
%               ../out/I2_ex.bmp
%###############################################################################%
disp('Running "pro2_a" ...');
pro2_a;
